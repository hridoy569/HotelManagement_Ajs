...
public class Billing {
  ...
  String BillEntryDate, BillingMode, CardNumber;
    ...
    public Billing(int BillNo, int BookingNo, int BillingDays, int TotalRoomRent, int ServiceCharge, int GrossBillAmount, int ServiceTax, int DiscountAllowed, int NetBillAmount, int AmountRecived, int OutstandingAmount, String BillEntryDate, String BillingMode, String CardNumber) {
        this.BillNo = BillNo;
